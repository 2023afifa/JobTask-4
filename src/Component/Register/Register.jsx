...
const Signup = () => {
    ...
    return (
        <div>
            <div className="card max-w-xl shadow-xl bg-sky-300 my-10 mx-auto rounded-sm">
                <h2 className="text-center text-3xl text-sky-700 font-bold pt-10">Register Here</h2>
                <p className="text-center">If you already have an account <Link to="/login"><span className="text-sky-700 font-bold">Login</span></Link> here</p>
                <form onSubmit={handleRegister} className="card-body">
                    ...
                    <div className="mt-4 mx-auto">
                        <button className="btn normal-case border-none text-lg font-semibold bg-sky-600 text-white rounded-sm hover:bg-sky-500">Register</button>
                    </div>
                </form>
            </div>
        </div>
